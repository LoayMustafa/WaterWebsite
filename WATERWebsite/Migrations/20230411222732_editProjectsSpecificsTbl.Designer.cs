...
namespace WATERWebsite.Migrations
{
    ...
    [Migration("20230411222732_editProjectsSpecificsTbl")]
    partial class editProjectsSpecificsTbl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WATERWebsite.Core.Models.Projects", b =>
                {
                    b.Property<int>("ProjectCode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WATERWebsite.Core.Models.ProjectSpecific", b =>
                {
                    b.Property<int>("ProjectCode")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ProjectCode", "SpecificCode");

                    b.HasIndex("SpecificCode");

                    b.ToTable("ProjectSpecific");
                });
            ...
            modelBuilder.Entity("WATERWebsite.Core.Models.ProjectSpecific", b =>
                {
                    b.HasOne("WATERWebsite.Core.Models.Projects", "Project")
                        .WithMany("ProjectSpecific")
                        .HasForeignKey("ProjectCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WATERWebsite.Core.Models.Specifics", "Specific")
                        .WithMany("ProjectSpecific")
                        .HasForeignKey("SpecificCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
