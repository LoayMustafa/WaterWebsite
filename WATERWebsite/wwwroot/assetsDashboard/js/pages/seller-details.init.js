			...
			},
            {
                ...
                formatter: (function (cell) {
                    return gridjs.html('<div class="d-flex align-items-center">' +
                        ...
                        '<div class="avatar-sm bg-light rounded p-1"><img src="/assetsDashboard/images/products/' + cell[0] + '" alt="" class="img-fluid d-block"></div>' +
                        '</div>' +
                        '<div class="flex-grow-1">' +
                        '<h5 class="fs-14 mb-1"><a href="ProductDetails" class="text-body">' + cell[1] + '</a></h5>' +
