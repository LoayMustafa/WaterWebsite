...
(function () {
    var dummyUserImage = "/assetsDashboard/images/users/user-dummy-img.jpg";
    var dummyMultiUserImage = "/assetsDashboard/images/users/multi-user.jpg";
    ...
    var emojiPicker = new FgEmojiPicker({
        ...
        position: ["top", "right"],
        preFetch: true,
        dir: "/assetsDashboard/js/pages/plugins/json",
