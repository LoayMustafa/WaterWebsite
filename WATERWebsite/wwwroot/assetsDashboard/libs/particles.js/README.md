...
particlesJS.load('particles-js', '/assetsDashboard/particles.json', function() {
...
`particles.shape.image.src` | path link <br /> svg / png / gif / jpg | `"/assetsDashboard/img/yop.svg"` <br /> `"http://mywebsite.com/assetsDashboard/img/yop.png"`
